<div class="container">
    <div class="card">
        <div class="card-header border-bottom">
            <h3 class="card-title">REALISASI EVENT</h3>
            <div class="text-end">
                <?php if ($role != 'MKT') { ?>
            ...
            <div class="card-datatable table-responsive">
                <table id="example1" class="table table-nobordered" style="width:100%">
                    ...
                    <tbody>
                        ...
                        WHERE proposal_pengajuans.realisasi NOT IN (3, 1, 4)
                    ...
                    ");
                        ...
                        INNER JOIN lokasi_pamerans ON lokasi_pamerans.no_lokasi = proposal_pengajuans.no_lokasi 
                        INNER JOIN master_dealer ON master_dealer.no_dlr = proposal_pengajuans.no_dlr
                        WHERE proposal_pengajuans.realisasi NOT IN (3, 1, 4) AND proposal_pengajuans.no_dlr = '$role'
                        ORDER BY proposal_pengajuans.no_pengajuan DESC
                                            ");
                        }
                            ...
                            <tr> <!-- DITAMBAHKAN -->
                                ...
                                <td>
                                    <?php if ($role != 'MKT') { ?>
                                        ...
                                        <a type="button" class="btn btn-icon btn-primary" title="edit" href="?page=realisasiupdate&nopengajuan=<?php echo $key['no_pengajuan']; ?>">
